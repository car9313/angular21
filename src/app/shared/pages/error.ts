...
@Component({
    selector: 'app-error',
    imports: [ButtonModule, RippleModule, RouterModule, AppFloatingConfigurator, NgOptimizedImage],
    standalone: true,
                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, rgba(233, 30, 99, 0.4) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                        <div class="gap-4 flex flex-col items-center">
                            ...
                            <img ngSrc="assets/img/asset-error.svg" alt="Error" class="custom-image" width="200" height="100" />
                            <div class="col-span-12 mt-8 text-center">
                                <p-button label="Ir al Panel principal" routerLink="/" severity="danger" />
                            </div>
                        </div>
                    </div>
                </div>
